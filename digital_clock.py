...
def date_time():	
	...
	hr = time.strftime('%I') # to count only hours
	mi = time.strftime('%M')
	sec = time.strftime('%S')
	am = time.strftime('%p')

	date = time.strftimw("%d")
	...
	lab_hr.after(200, date_time) # change the data after every 200 millisec, datetime module will do this through automatic loop
...
lab_hr=Label(clock,text="000",font="Time New Roman",60,"bold"),bg='Red',fg='white')
...
lab_min=Label(clock,text="000",font="Time New Roman",60,"bold"),bg='Red',fg='white')
...
lab_sec=Label(clock,text="000",font="Time New Roman",60,"bold"),bg='Red',fg='white')
...
lab_am=Label(clock,text="000",font="Time New Roman",60,"bold"),bg='Red',fg='white')
...
lab_date=Label(clock,text="000",font="Time New Roman",60,"bold"),bg='Red',fg='white')
...
lab_mo=Label(clock,text="000",font="Time New Roman",60,"bold"),bg='Red',fg='white')
...
lab_year=Label(clock,text="000",font="Time New Roman",60,"bold"),bg='Red',fg='white')
...
lab_day=Label(clock,text="000",font="Time New Roman",35,"bold"),bg='Red',fg='white')
...
# note config is changing and editing everything 